...
<body>
	<div class="container">
		<h1 class="mt-5 p-3 text-center display-2">
			<strong>Listado de <span style="color: green;">Donaciones
					Físicas</span></strong>
		</h1>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title fs-5" id="exampleModalLabel">Donaciones
							Físicas</h1>
					</div>
					<div class="modal-body">

						<form id="formDonFisi" method="post"
							action="ServletDonacionFisico?accion=insertar">
							...
							<div class="form-group">
								<label for="exampleInputEmail2" class="form-label">DNI
									Donantes</label> <select class="form-select form-control"
									aria-label="Default select example" name="dnidonante"
									id="id-dnidonante">
									<option value="" readonly selected hidden="disable">Seleccione
										un DNI</option>
								</select>
							</div>
							...
							<div class="form-group">
								<label for="exampleInputEmail2" class="form-label">Lugar
									...
									aria-label="Default select example" id="id-local"
									name="idlocal">
							...
							<div class="form-group">
								...
								<textarea class="form-control"
									placeholder="Donaré una caja llena de alimentos no perecederos, mantas y ropa abrigada para apoyar a las personas."
							...
							<div class="form-group">
								...
								<select class="form-select form-control"
									...
									id="id-estado">
									<option value="" selected hidden="disable">Seleccione
										el estado de la donación</option>
		...
		<%--Tabla --%>
		<div class="mt-5">
			<table id="tablaDonFisi" class="table table-striped table-bordered"
				style="width: 100%">
				<thead>
					<tr>
						<th>ID</th>
