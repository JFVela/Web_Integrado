					...
					<div>
						<div>
							<p class="parr">
								...
								> <a href="Nosotros_Colaboradores.jsp" class="color-a">Nuestra
									Colaboradores</a>
							</p>
						</div>
						<div>
			...
			<div class="row">
				<div class="col-7 mx-auto">
					<div class="text-center pt-5">
						...
						<p class="jus text-secondary">Nuestra ONG está compuesta por
							un equipo apasionado de estudiantes universitarios que están
							comprometidos con la creación de un impacto positivo en nuestra
							comunidad y más allá. Juntos, combinamos una variedad de
							talentos, conocimientos y experiencias para llevar a cabo nuestra
							misión. Conócenos un poco mejor:</p>
					</div>
					<div class="borde"></div>
				</div>
			</div>
				...
				<div class="col-md-10 offset-md-1">
					<div class="qa-item">
						<div class="row align-items-center">
							<div class="col-md-4">
								<h3>
									Diego Mathias Bautista<br> López
								</h3>
								<img src="img/00.png" class="card-img-top tam-img" alt="...">

							</div>
							<div class="col-md-8">
								<p class="jus2">Diego es un estudiante de Ingeniería de
									Sistemas con un profundo interés en la tecnología y la
									innovación. Su experiencia en gestión de proyectos y su
									habilidad para resolver problemas son fundamentales para la
									implementación exitosa de nuestras iniciativas tecnológicas.</p>
							</div>
						</div>
					</div>
					<div class="qa-item">
						<div class="row align-items-center">
							...
							<div class="col-md-8">
								<p class="jus2">Juan es un estudiante de Ingeniería de
									Sistemas apasionado por la programación y la solución de
									desafíos tecnológicos. Desarrolla aplicaciones y sistemas que
									mejoran nuestra eficiencia interna y nuestra capacidad para
									alcanzar a la comunidad.</p>
							</div>
						</div>
					</div>
					<div class="qa-item">
					...
					<div class="qa-item">
						<div class="row align-items-center">
							...
							<div class="col-md-8">
								<p class="jus2">Juan es un estudiante de Ingeniería de
									Software apasionado por el desarrollo de aplicaciones y
									software de calidad. Contribuye a la creación y mejora de
									nuestras herramientas tecnológicas, asegurando que estén
									alineadas con nuestra misión.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row ">
				<div class="col-9 mx-auto d-flex">
					...
					<div>
						...
						<p class="est-p">Estamos emocionados por el apoyo inicial que
							hemos recibido, y esperamos que más personas se unan a nosotros
							en nuestro viaje para crear un impacto positivo en la comunidad.
							Si estás interesado en colaborar con nosotros o conocer más
							acerca de nuestro proyecto, ¡no dudes en ponerte en contacto con
							nosotros!</p>
					</div>
				</div>
		...
		<div class="container-fluid">
			<div class="row ">
				...
				<div class="col p-5">
					...
					<p class="espa-r jus2">La Universidad Tecnológica del Perú es
						nuestro principal aliado en la misión de nuestra ONG. Esta
						institución académica de renombre ha demostrado un compromiso
						excepcional con nuestra visión de crear un mundo mejor a través
						del servicio comunitario y la responsabilidad social. Su apoyo
						inquebrantable ha sido fundamental en cada paso de nuestro camino.</p>
				</div>
			</div>
		</div>
	</section>
