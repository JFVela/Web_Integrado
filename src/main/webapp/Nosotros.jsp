...
<head>
	...
	<style>
        ...
        .tarjeta::before {
            ...
            transition: transform 0.3s ease, background-color 0.3s ease; /* Transición para el efecto de escala y el cambio de color */
            z-index: 1; /* Coloca el fondo sobre el contenido */
        }

        /* Estilo para el fondo al pasar el mouse */
        .tarjeta:hover::before {
            background-color: rgba(0, 0, 255, 0.3); /* Fondo ligeramente transparente al pasar el mouse */
        ...
        .tarjeta::after {
            content: "";
            position: absolute;
            top: -10px; /* Ajusta el espacio del fondo blanco desde la parte superior */
            left: -10px; /* Ajusta el espacio del fondo blanco desde la izquierda */
            right: -10px; /* Ajusta el espacio del fondo blanco desde la derecha */
            bottom: -10px; /* Ajusta el espacio del fondo blanco desde la parte inferior */
            background-color: rgba(255, 255, 255, 0); /* Color de fondo blanco transparente */
            ...
            pointer-events: none; /* Evita que el fondo blanco bloquee interacciones con el contenido */
        }

        /* Estilo para el fondo blanco al pasar el mouse */
        .tarjeta:hover::after {
            background-color: rgba(255, 255, 255, 0.8); /* Fondo blanco transparente al pasar el mouse */
        }
		...
		.tarjeta:hover .estilo-boton {
		    background-color: transparent; /* Cambia el color de fondo al color deseado */
		    color: white; /* Puedes ajustar el color de texto según tus preferencias */
				...
				<div class="d-flex">
						...
						<div class="card text-bg-dark tarjeta  tamaño-card">
						  ...
						  <div class="card-img-overlay">
						    <div class="tarjeta-texto">
                               <h1 class="card-title fond"><strong>RENOVANDO</strong></h1><br>
                               <h1 class="card-title fond"><strong>VIDAS</strong></h1>
					...
					<div class="w-100">
						<div class="card text-bg-dark tarjeta tamaño-card">
						  ...
						  <div class="card-img-overlay">
						    <div class="tarjeta-texto">
                               <h1 class="card-title fond"><strong>NUESTRA</strong></h1><br>
                               <h1 class="card-title fond"><strong>HISTORIA</strong></h1>
                               <p class="card-text fon2">Enterate más sobre la historia
                               de nuestra organización.</p>
							<a class="btn estilo-boton" href="Nosotros_historia.jsp">VER MÁS</a>
					...
					<div class="w-100">
						<div class="card text-bg-dark tarjeta tamaño-card">
						  ...
						  <div class="card-img-overlay">
						    <div class="tarjeta-texto">
                               <h1 class="card-title fond"><strong>NUESTROS</strong></h1><br>
                               <h1 class="card-title fond"><strong>COLABORADORES</strong></h1>
							<p class="card-text fon2">Encuentra aquí las 
							entidades que colaboran a nuesta causa.</p>			
							<a class="btn estilo-boton" href="Nosotros_Colaboradores.jsp">VER MÁS</a>
						    </div>
						  </div>
						</div>
					</div>
		...
		<div class="container-fluid fondo-g p-5">
			<div class="row">
				<div class="col-7 mx-auto text-light text-center">
					...
					<hr class="linea">
					<p class="justi pt-3 ">
						Renovando Vidas es un faro de esperanza en un mundo que
						a menudo enfrenta desafíos abrumadores. Su dedicación
					    incansable a la transformación de vidas ha tocado 
					    corazones y cambiado destinos. Cada contribución, 
					    grande o pequeña, se traduce en un cambio significativo.
					    Únete a nosotros en el apoyo a esta causa digna y sé 
					    parte del cambio que Renovando Vidas está liderando 
					    en nuestro mundo.Su enfoque en la igualdad, la 
					    compasión y la sostenibilidad guía cada paso que dan, 
					    asegurando que su labor tenga un impacto duradero. Con 
					    Renovando Vidas, puedes estar seguro de que tu ayuda 
					    marca la diferencia y contribuye a un mundo más justo 
					    y solidario. ¡Únete a esta causa inspiradora hoy mismo!"
					</p>
				</div>
			</div>
		</div>
