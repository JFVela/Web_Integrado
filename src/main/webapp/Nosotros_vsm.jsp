...
.relative-container {
	position: relative;
	/* Necesario para el posicionamiento absoluto dentro */
}
...
.overlay-content {
	...
	/* Corrige la posición para centrar */
			...
			<div class="container ">
				<div class="row">
					<div>
						<div>
							<p class="parr">
								<a href="menu.jsp">Inicio</a> > <a href="Nosotros.jsp">Nosotros</a>
								> <a href="Nosotros_vsm.jsp" class="color-a">Renovando Vidas</a>
							</p>
						</div>
						<div class="fond">
							<h1>
								<strong>RENOVANDO VIDAS</strong>
							</h1>
						</div>
					</div>
				</div>
		...
		<div class="container mt-5">
			<div class="row text-center">
				<div class="col-9 mx-auto d-flex">
					...
					<p class="justif">
						Renovando Vidas es una organización sin fines de lucro
						comprometida con la transformación positiva de comunidades
						desfavorecidas. Fundada en 20XX, nuestra misión es promover el
						Desarrollo Humano Integral, basado en valores de igualdad,
						solidaridad y el respeto a la dignidad de cada individuo.<br>
						<br>A lo largo de los años, "Renovando Vidas" ha colaborado
						estrechamente con una red de asociados a nivel nacional,
						trabajando incansablemente para mejorar la vida de aquellos que
						más lo necesitan. <br>
						<br>Además, somos parte de la comunidad global de
						organizaciones comprometidas con el cambio social, formando parte
						de alianzas internacionales que buscan un mundo más justo y
						equitativo."Renovando Vidas" se enorgullece de ser un actor activo
						en la lucha contra la pobreza y de trabajar incansablemente para
		...
		<div class="container-fluid ">
			<div class="row text-light justify-content-center">
				<div class="col-5 text-center mx-3 bg-info brd p-2">
					<h2>Misión</h2>
					<p class="justif text-center">
						<strong>Despertando sueños, transformamos vidas</strong>
					</p>
					<p class="justif">Nuestra misión es promover el desarrollo
						humano integral y sostenible de las personas en condici6n de
						vulnerabilidad, en alianza con otras instituciones y
						organizaciones de la sociedad civil. Guiados por principios éticos
						y valores universales, trabajamos incansablemente para construir
						un mundo más justo y solidario.</p>
				</div>
				<div class="col-5 text-center mx-3 bg-info brd p-2">
					<h2>Visión</h2>
					<p class="justif text-center">
						<strong>Visión: "Rumbo a la autogestión para la acción"</strong>
					</p>
					<p class="justif">Para el año 2024, nos convertiremos en una
						red humanitaria lider y de referencia a nivel nacional,
						extendiendo nuestra mano solidaria a quienes mås Io necesitan,
						transformando vidas y contribuyendo al florecimiento de una
						sociedad mås igualitaria y compasiva.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container mt-5">
			<div class="row text-center">
				<div class="col-9 mx-auto d-flex">
					...
					<p class="justif">Transformando almas, reviviendo esperanzas y
						renovando vidas. Nuestra ONG, 'Renovando Vidas', se compromete a
						inspirar un cambio significativo en la sociedad. Trabajamos
						incansablemente para empoderar a aquellos que más lo necesitan y
						construir un mundo más justo y solidario. Juntos, creamos un
						futuro lleno de oportunidades y transformamos vidas con compasión
						y dedicación.</p>
				</div>
			</div>
		</div>
				...
				<div class="row text-light ">
					<div class="fondo-a alt">
						...
						<div class="row justify-content-center gy-4 p-5">
							<div
								class="col-lg-5 col-xl-3 col-sm-6 offset-lg-false offset-xl-0">
								<div
									class="wp-block-group is-style-bottom-border 
								...
								wp-block-group-is-layout-constrained">
									<div class="wp-block-group__inner-container">
										...
										<h4 class="wp-block-heading">
											Primero <br> Las Personas
										</h4>
										<p style="font-size: 16px">Trabajamos de la mano de las
											personas desde la empatía, la solidaridad y el mutuo
											reconocimiento.</p>
									</div>
								</div>
							</div>
							<div
								class="col-lg-5 col-xl-3 col-sm-6 offset-lg-false offset-xl-0 espacio-top">
								<div
									class="wp-block-group is-style-bottom-border has-indigo-color
								 ...
								 px-sm-4 py-4 is-layout-constrained wp-block-group-is-layout-constrained">
									<div class="wp-block-group__inner-container">
										...
										<h4 class="wp-block-heading">
											Actuamos <br> con integridad
										</h4>
										<p style="font-size: 16px">Llevamos la ética, el respeto y
											la transparencia a cada lugar y en todo lo que hacemos.</p>
									</div>
								</div>
							</div>
							<div
								 ...
								 has-light-background-color has-text-color has-background px-3 px-sm-4
								  py-4 is-layout-constrained wp-block-group-is-layout-constrained">
									<div class="wp-block-group__inner-container">
										...
										<h4 class="wp-block-heading">
											Buscamos la excelencia <br> y la innovación
										</h4>
										<p style="font-size: 16px">Cuestionamos, desaprendemos,
											recreamos y transformamos realidades.</p>
									</div>
								</div>
							</div>
							<div
								class="col-lg-5 col-xl-3 col-sm-6 offset-lg-false offset-xl-0 espacio-top">
								<div
									class="wp-block-group is-style-bottom-border has-indigo-color has-light-background-color has-text-color has-background px-3 px-sm-4 py-4 is-layout-constrained wp-block-group-is-layout-constrained">
									<div class="wp-block-group__inner-container">
										<div class="row justify-content-end">
											<div class="col-6">
												<figure class="wp-block-image size-large">
										...
										<h4 class="wp-block-heading">
											Llevamos los derechos <br> a la práctica
										</h4>
										<p style="font-size: 16px">Vivimos con igualdad y
											respetamos la diversidad y el ejercicio de derechos de las
											personas.</p>
									</div>
								</div>
							</div>
						...
						<div class="col-md-3 col-sm-12">
							<div class="footer-widget">
								<div class="widget-about">
									...
									<p id="footerp">Organización sin fines de lucro creada para ayudar a los más
										neceesitados del Perú</p>
							...
							<div class="footer-widget">
								<div class="footer-menu footer-menu--1">
									...
									<ul id="footerul">
										...
										<li id="footerli">
											<a id="footera" href="Donacion.jsp">Donar</a>
										</li>
										<li id="footerli">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="copyright-text">
								<p id="footerp">© 2023
									<a id="footera" href="#">Renovando Vidas</a>. Todos los derechos reservados. Creado
									por
