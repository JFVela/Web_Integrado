...
Boolean autenticado = (sessio != null && sessio.getAttribute("voluntario") != null
		&& (Boolean) sessio.getAttribute("voluntario"));
					...
					<div class="sc-40aa91e1-6 gmSAms">
						<div class="sc-51c12d65-0 dYSiPu">
							<div class="sc-51c12d65-1 eiMKJA">
								<h1 class="sc-51c12d65-3 bdLOnx">¡Estás dentro del
									voluntariado!</h1>
								<h2 class="sc-51c12d65-4 benWpN">
									Te enviaremos un email a <span id="email"></span> cuando sea tu
									turno de ayudar a la comunidad.
								</h2>
								<div>
									<div class="sc-bb267fd9-1 cGCLHA">
										<a class="sc-bb267fd9-2 fopBtT" href="voluntariado.jsp">Volver
											a voluntariados</a>
									</div>
									<h3 class="sc-bb267fd9-0 dQQKZW">¿Quieres saber más?</h3>
									<p class="sc-40aa91e1-1 kvLTRA">
										Mientras esperas, echa un vistazo a nuestras historias y
										eventos que se estan relizando.<a href="HisExito.jsp"> 👇</a>
									</p>
								</div>
							</div>
							<div class="sc-51c12d65-2 gOtVzG">
								<a class="sc-4ffe2525-0 fzWmrg" href="voluntariado.jsp#fa1">
									<div class="sc-4ffe2525-1 jQhqCk">¿Todavía tienes
										preguntas?</div>
									<div class="sc-4ffe2525-2 ixCKCP">Nuestras preguntas
										frecuentes proporcionan más información sobre los
										voluntariados</div>
								</a>
							</div>
						</div>
