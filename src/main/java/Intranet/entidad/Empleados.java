...
public class Empleados {
	...
	private Roles rol;
	private int ongNumber;
	private ongEmpresa ong;
	...
	public int getOngNumber() {
		return ongNumber;
	}

	public void setOngNumber(int ongNumber) {
		this.ongNumber = ongNumber;
	}

	public ongEmpresa getOng() {
		return ong;
	}

	public void setOng(ongEmpresa ong) {
		this.ong = ong;
	}
