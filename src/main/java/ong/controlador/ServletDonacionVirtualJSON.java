...
@WebServlet("/ServletDonacionVirtualJSON")
public class ServletDonacionVirtualJSON extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ServletDonacionVirtualJSON() {
        super();
    }

	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//obtener lista de todos
				List<DonacionVirtual> lista=new MySqlDonacionVirtualDAO().findAll();
